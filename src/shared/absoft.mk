...
libjk$(DEBUG).a: atypes.o binio.o jstep.o ktransf.o utils.o params.o timer.o cutils.o $(MKFS)
	$(AR) $(ARFLAGS) $@ atypes.o binio.o jstep.o ktransf.o utils.o params.o timer.o cutils.o
...
timer.o TIMER.mod: timer.F90 $(MKFS)
