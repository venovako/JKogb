...
SUBROUTINE BOPEN_YJ_RO(FN, M, N, SZ, FD, INFO)
  IMPLICIT NONE
...
1 SZ = DIFFSZ
END SUBROUTINE BOPEN_YJ_RO

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

SUBROUTINE BREAD_YJ(FD, Y, J, M, N, SZ, INFO)
  IMPLICIT NONE
...
END SUBROUTINE BREAD_YJ

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

SUBROUTINE BOPEN_UZS_RW(FN, M, N, SZ, FD, INFO)
  IMPLICIT NONE
  CHARACTER(LEN=*,KIND=c_char), INTENT(IN) :: FN
  INTEGER, INTENT(IN) :: M, N
  ...
  IF (FD(3) .LT. 0) THEN
     ...
     RETURN
  END IF
END SUBROUTINE BOPEN_UZS_RW

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

SUBROUTINE BWRITE_UZS(FD, YU, Z, SY, M, N, INFO)
  IMPLICIT NONE
  INTEGER, INTENT(IN) :: FD(3), M, N
  COMPLEX(KIND=DWP), INTENT(IN), TARGET :: YU(M,N)
  COMPLEX(KIND=DWP), INTENT(IN), TARGET :: Z(N,N)
