PROGRAM DJK
  ...
  INTEGER :: N, N_2, B, ID_MAG, ID_CMP, ID_TRU, INFO, NN, NT, SZ(3), FD(3)
  TYPE(DPROC) :: R
  ...
  CALL READCL(FN, N, N_2, B, ID_MAG, ID_CMP, ID_TRU, INFO)
  IF (INFO .NE. 0) STOP 'zjk.exe FN N N_2 [B [ID_MAG [ID_CMP [ID_TRU]]]]'
#ifndef NDEBUG
