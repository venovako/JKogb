PROGRAM DJK
  ...
  INTEGER :: N, N_2, ID_MAG, ID_NCP, ID_TRU, INFO, NN, NM, NT, TT, SZ(3), FD(3)
  TYPE(DPROC) :: R
  ...
  CALL READCL(FN, N, N_2, ID_MAG, ID_NCP, ID_TRU, INFO)
  IF (INFO .NE. 0) ERROR STOP 'djk.exe FN N N_2 [ID_MAG [ID_NCP [ID_TRU]]]'
#ifndef NDEBUG
  ...
  CALL DPROC_INIT(NT, ID_MAG, ID_NCP, ID_TRU, R, INFO)
#ifndef NDEBUG
